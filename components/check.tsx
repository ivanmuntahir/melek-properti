...
import FeatImage02 from "@/.next/static/media/layanan-2-cropped.b4679ffb.jpg";
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
            ...
            >
              <p className="text-xl text-gray-400 ">
                ...
                surat keputusan tertanggal 3 April 1990 Nomor:
            ...
            >
              <div className="md:pr-4 lg:pr-12 xl:pr-16">
                ...
                <p className="text-xl text-gray-400 mb-4">
                  ...
                  maupun perusahaan besar. SB Finance beroperasi dengan
                  menjunjung tinggi visi, misi, dan corporate values perusahaan
                  untuk terus berkontribusi terhadap pertumbuhan perekonomian
                  nasional dan portfolio pembiayaan di Indonesia.
                </p>
              </div>
            </div>
          </div>
